...
func TestValidateInt_ok(t *testing.T) {
	err := validators.ValidateInt("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateInt_error(t *testing.T) {
	err := validators.ValidateInt("FooBar", "foo-bar", "xx")
...
func TestValidateInt8_ok(t *testing.T) {
	err := validators.ValidateInt8("FooBar", "foo-bar", "12")
	assert.Nil(t, err)
}

func TestValidateInt8_error(t *testing.T) {
	err := validators.ValidateInt8("FooBar", "foo-bar", "xx")
...
func TestValidateInt16_ok(t *testing.T) {
	err := validators.ValidateInt16("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateInt16_error(t *testing.T) {
	err := validators.ValidateInt16("FooBar", "foo-bar", "xx")
...
func TestValidateInt32_ok(t *testing.T) {
	err := validators.ValidateInt32("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateInt32_error(t *testing.T) {
	err := validators.ValidateInt32("FooBar", "foo-bar", "xx")
...
func TestValidateInt64_ok(t *testing.T) {
	err := validators.ValidateInt64("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateInt64_error(t *testing.T) {
	err := validators.ValidateInt64("FooBar", "foo-bar", "xx")
...
func TestValidateUint_ok(t *testing.T) {
	err := validators.ValidateUint("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateUint_error(t *testing.T) {
	err := validators.ValidateUint("FooBar", "foo-bar", "xx")
...
func TestValidateUint8_ok(t *testing.T) {
	err := validators.ValidateUint8("FooBar", "foo-bar", "12")
	assert.Nil(t, err)
}

func TestValidateUint8_error(t *testing.T) {
	err := validators.ValidateUint8("FooBar", "foo-bar", "xx")
...
func TestValidateUint16_ok(t *testing.T) {
	err := validators.ValidateUint16("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateUint16_error(t *testing.T) {
	err := validators.ValidateUint16("FooBar", "foo-bar", "xx")
...
func TestValidateUint32_ok(t *testing.T) {
	err := validators.ValidateUint32("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateUint32_error(t *testing.T) {
	err := validators.ValidateUint32("FooBar", "foo-bar", "xx")
...
func TestValidateUint64_ok(t *testing.T) {
	err := validators.ValidateUint64("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateUint64_error(t *testing.T) {
	err := validators.ValidateUint64("FooBar", "foo-bar", "xx")
...
func TestValidateFloat32_ok(t *testing.T) {
	err := validators.ValidateFloat32("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateFloat32_error(t *testing.T) {
	err := validators.ValidateFloat32("FooBar", "foo-bar", "xx")
...
func TestValidateFloat64_ok(t *testing.T) {
	err := validators.ValidateFloat64("FooBar", "foo-bar", "123")
	assert.Nil(t, err)
}

func TestValidateFloat64_error(t *testing.T) {
	err := validators.ValidateFloat64("FooBar", "foo-bar", "xx")
